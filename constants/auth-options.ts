...
export const authOptions: AuthOptions = {
    providers: [
        CredentialsProvider({
            ...
            async authorize(credentials) { //проверка данных входа по бд
                ...
                // TODO: сделать дашбоард - по сути просто окно с выводом всех юзеров, где админ мог бы менять роли не админам
            }
        })
    ],
    ...
    callbacks: {
        ...
        async signIn({ account }) {
            // // 2fa неважно TODO логику 2фа возможно можно прописать именно здесь. Для 2fa нужен Resend. Для Resend нужен домен. Иначе он работает только с моей почтой
            try {
